...
enum FFColors {
    // Warm neutral palette inspired by premium editorial fitness apps.
    ...
    static let gray500 = Color(red: 0.49, green: 0.44, blue: 0.39)
    static let gray700 = Color(red: 0.89, green: 0.86, blue: 0.82)

    static let danger = Color(red: 0.64, green: 0.24, blue: 0.24)
}
